...
public class AEOTPTextField: UITextField {
    ...
    public var otpFilledBackgroundColor: UIColor = .clear//UIColor(red: 0.949, green: 0.949, blue: 0.949, alpha: 1)
    ...
    public var otpFontSize: CGFloat = 15
    /// The default font of the text
    public var otpFont: UIFont = UIFont(name: "Poppins Medium", size: CGFloat(15.0))!
    ...
    public func configure(with slotCount: Int = 8) {
