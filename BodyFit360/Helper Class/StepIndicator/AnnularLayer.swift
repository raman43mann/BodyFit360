...
class AnnularLayer: CAShapeLayer {
    ...
    override init() {
        ...
        if AnnularLayer.flagCGImage == nil {
            var flagImage = UIImage(named: BFImageNames.stepIndicatorDone)
            ...
            if flagImage == nil {
                ...
                if let url = bundle.url(forResource: "StepIndicator", withExtension: "bundle") {
                    ...
                    flagImage = UIImage(named: BFImageNames.stepIndicatorDone, in: bundle, compatibleWith: nil)
                }
            }
    ...
    private func drawText(done: Bool? = nil) {
        let sideLength = fmin(self.frame.width, self.frame.height)
        ...
        self.centerTextLayer.foregroundColor = done != nil ? UIColor.black.cgColor : self.strokeColor
